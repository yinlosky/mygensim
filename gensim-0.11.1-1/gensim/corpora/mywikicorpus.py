...
logger = logging.getLogger('gensim.corpora.mywikicorpus')
...
class myWikiCorpus(TextCorpus):
    ...
    def get_texts(self):
        ...
        logger.info("finished iterating over myWikipedia corpus of %i documents with %i positions"
